...
test("keeps the requested budget capabilities in the product source", async () => {
  ...
  assert.match(app, /csvImportKind/);
  assert.match(app, /csvHasDebitDates/);
  assert.match(app, /Relevé de compte classique/);
  assert.match(app, /Relevé carte différée/);
  ...
  assert.match(app, /Disponible après cartes/);
  assert.match(app, /Mettre à jour le solde réel/);
  assert.match(app, /transaction-row-deferred/);
  assert.match(app, /account-deferred-breakdown/);
  ...
  assert.match(css, /\.transaction-row-deferred/);
  assert.match(css, /\.deferred-card-badge/);
  assert.match(css, /\.account-deferred-breakdown/);
  assert.match(css, /\.import-kind-switch/);
